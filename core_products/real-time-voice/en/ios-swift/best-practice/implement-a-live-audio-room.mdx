...
- Complete SDK integration by referring to [**Quick Start**](../quick-start/implementing-voice-call) doc.
...
The usage of basic SDK functions has been introduced by [Quick start](../quick-start/implementing-voice-call). If you are not familiar with the concept of stream publishing/playing, please read the document carefully again.
