...
- Complete SDK integration by referring to [**Quick Start**](../quick-start/implementing-live-streaming) doc.
...
The usage of basic SDK functions has been introduced by [Quick start](../quick-start/implementing-live-streaming). If you are not familiar with the concept of stream publishing/playing, please read the document carefully again.
