...
When playing streams, if an error occurs, please refer to [Common Error Codes - 1004xxx Play Stream Related Error Codes](/real-time-video-android-java/client-sdk/error-code#play-stream-errors).
