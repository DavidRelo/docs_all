...
To facilitate developers in implementing the integration of the two, ZEGO provides example code. Please refer to [AI Beauty Effects - Run Example Source Code](/ai-effects-android-java/quick-start/run-sample-codes).
