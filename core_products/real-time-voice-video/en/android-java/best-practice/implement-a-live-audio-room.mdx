...
In addition to implementing the above logic, the live audio room also needs to manage speaker seats. The speaker seat management function can usually be implemented using the [room attribute](/zim-android/guides/room/room-properties) feature of the ZIM SDK.
...
<Note title="Note">
The demo in this document is a pure client API + ZEGOCLOUD solution. If you have your own business server and want to do more logical extensions, you can use our [Server API](#server-api-14007) to pass RoomRequests and combine your server's room business logic to increase the reliability of your app.
```mermaid
